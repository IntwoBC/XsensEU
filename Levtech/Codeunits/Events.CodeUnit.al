codeunit 50101 "Events"
{
    ...
    begin
        ...
        //@@@@@@@@@@@@@@Dimension set Id updating with New ICP Dimension @@@@@@@@@@@
        SalesHeader."Dimension Set ID" := GetNewDimensionSetId(SalesHeader."Sell-to Customer No.", SalesHeader."Dimension Set ID");
        SalesHeader.Modify();
    end;
    ...
    begin
        ...
        if ICInboxSalesLine."IC Partner Ref. Type" <> ICInboxSalesLine."IC Partner Ref. Type"::" " then begin
            ...
            //@@@@@@@@@@@@@@Dimension set Id updating with New ICP Dimension @@@@@@@@@@@
            SalesLine."Dimension Set ID" := GetNewDimensionSetId(SalesLine."Sell-to Customer No.", SalesLine."Dimension Set ID");
        end;
    end;
    ...
    procedure GetNewDimensionSetId(CustomerId: code[20]; DimSetID: Integer): Integer
    var
    ...
    begin
        ...
        DefaultDimension.SetRange("No.", CustomerId);
        ...
        if TempDimSetEntry.Get(TempDimSetEntry."Dimension Set ID", GLSetup."Shortcut Dimension 5 Code") then
